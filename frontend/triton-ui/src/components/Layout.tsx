...
export default function Layout() {
  ...
  const navigation = [
    ...
    { name: 'Virtual Machines', href: '/vms', icon: ComputerDesktopIcon, current: false },
                ...
                <Dialog.Panel className="relative mr-16 flex w-full max-w-xs flex-1">
                  ...
                  <div className="flex grow flex-col gap-y-5 overflow-y-auto bg-white px-6 pb-4">
                    <div className="flex h-16 shrink-0 items-center">
                      <span className="text-2xl font-bold text-indigo-600">Triton Admin</span>
                    </div>
                  ...
                  <Menu.Button className="-m-1.5 flex items-center p-1.5">
                    ...
                    <div className="flex items-center">
                      ...
                      <span className="hidden lg:flex lg:items-center">
                        <span className="ml-4 text-sm font-medium text-gray-700 group-hover:text-gray-900">{user?.name}</span>
